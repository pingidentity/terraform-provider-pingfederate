...
- `decryption_key_pair_ref` (Attributes) (see [below for nested schema](#nestedatt--credentials--decryption_key_pair_ref))
...
- `secondary_decryption_key_pair_ref` (Attributes) (see [below for nested schema](#nestedatt--credentials--secondary_decryption_key_pair_ref))
...
- `ssl_auth_key_pair_ref` (Attributes) (see [below for nested schema](#nestedatt--credentials--outbound_back_channel_auth--ssl_auth_key_pair_ref))
...
- `signing_key_pair_ref` (Attributes) (see [below for nested schema](#nestedatt--credentials--signing_settings--signing_key_pair_ref))
...
- `metadata_url_ref` (Attributes) (see [below for nested schema](#nestedatt--metadata_reload_settings--metadata_url_ref))
