...
- `replicate_log_settings_on_save` (Boolean) Whether changes to Log Settings will automatically be replicated to the cluster. Defaults to `false`. This attribute is only supported on PingFederate versions 13.0 and later.
