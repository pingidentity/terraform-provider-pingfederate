...
!> The pingfederate_key_pair_signing_import data source is deprecated and will be removed in a future release. Use the pingfederate_keypairs_signing_key data source instead.
