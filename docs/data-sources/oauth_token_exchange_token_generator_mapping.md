...
page_title: "pingfederate_oauth_token_exchange_token_generator_mapping Data Source - terraform-provider-pingfederate"
subcategory: ""
description: |-
  Describes the mapping from a token exchange processor policy to a token generator.
---

# pingfederate_oauth_token_exchange_token_generator_mapping (Data Source)
