...
!> The `pingfederate_oauth_auth_server_settings` data source has been renamed and will be removed in a future release. Use the `pingfederate_oauth_server_settings` data source instead.
