...
subcategory: ""
description: |-
  Describes details of an SSL key pair.
---
...
!> The pingfederate_key_pair_ssl_server_import data source is deprecated and will be removed in a future release. Use the pingfederate_keypairs_ssl_server_key data source instead.
