...
page_title: "pingfederate_openid_connect_policy Data Source - terraform-provider-pingfederate"
subcategory: ""
description: |-
  Describes an OpenID Connect Policy.
---

# pingfederate_openid_connect_policy (Data Source)
...
```terraform
data "pingfederate_openid_connect_policy" "myOIDCPolicy" {
  policy_id = "myOIDCPolicyExampleId"
}
```
