...
func ToDataSourceState(con context.Context, attributeContractFulfillmentFromClient map[string]client.AttributeFulfillmentValue) (basetypes.MapValue, diag.Diagnostics) {
