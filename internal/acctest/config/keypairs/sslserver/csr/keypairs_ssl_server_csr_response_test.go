		...
		Steps: []resource.TestStep{
			{
				...
				Config: keypairsSslServerCsrResponse_HCL(keypairs.CsrResponse1),
				Check:  keypairsSslServerCsrResponse_CheckComputedValuesInitial(),
			},
			{
				// Importing a second CSR response
				Config: keypairsSslServerCsrResponse_HCL(keypairs.CsrResponse2),
...
func keypairsSslServerCsrResponse_CheckComputedValuesInitial() resource.TestCheckFunc {
	return resource.ComposeTestCheckFunc(
		...
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "serial_number", "8770436850221969673930962783985572962"),
		...
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "valid_from", "2025-07-30T19:13:37Z"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "expires", "2045-07-25T19:13:37Z"),
		...
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "sha1_fingerprint", "3449766B67B306DE781CE2C9D4C23D527D13EB04"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "sha256_fingerprint", "6B81F1BC63C36E41A949B4A3715135939A4511EA9658FA5BA57944AE5DCA437E"),
...
func keypairsSslServerCsrResponse_CheckComputedValuesUpdated() resource.TestCheckFunc {
	return resource.ComposeTestCheckFunc(
		resource.TestCheckNoResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "crypto_provider"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "id", "419x9yg43rlawqwq9v6az997k"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "serial_number", "99377934021464408054402725272426356391"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "subject_dn", "CN=common, O=org, C=US"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "subject_alternative_names.#", "0"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "issuer_dn", "CN=Example Authority, O=Example Corporation, C=US"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "valid_from", "2025-07-30T19:21:47Z"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "expires", "2045-07-25T19:21:47Z"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "key_algorithm", "RSA"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "key_size", "2048"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "signature_algorithm", "SHA256withRSA"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "version", "3"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "sha1_fingerprint", "4975FB3948D3FBD270CA25E123931BF114840EAF"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "sha256_fingerprint", "E88E5596EF241003FD2E2F702A7D832CC7F8D3FBF68F38FDF47645D83387C9C1"),
		resource.TestCheckResourceAttr("pingfederate_keypairs_ssl_server_csr_response.example", "status", "VALID"),
	)
}
