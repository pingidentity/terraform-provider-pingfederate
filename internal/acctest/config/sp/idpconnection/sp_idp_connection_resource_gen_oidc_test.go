...
func TestAccSpIdpConnection_OidcUnexpectedPlan(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck: func() { acctest.ConfigurationPreCheck(t) },
		ProtoV6ProviderFactories: map[string]func() (tfprotov6.ProviderServer, error){
			"pingfederate": providerserver.NewProtocol6WithError(provider.NewTestProvider()),
		...
		Steps: []resource.TestStep{
			{
				// Ensure no unexpected plans are generated by the sso_application_endpoint attribute
				Config: spIdpConnection_UnexpectedPlanSsoApplicationEndpointHCL(),
			},
			{
				Config: spIdpConnection_OidcMinimalHCL(),
				Check:  spIdpConnection_CheckComputedValuesOidcMinimal(),
...
func spIdpConnection_UnexpectedPlanSsoApplicationEndpointHCL() string {
	return fmt.Sprintf(`
%s
...
resource "pingfederate_sp_idp_connection" "example" {
  ...
  idp_browser_sso = {
    ...
    oidc_provider_settings = {
      ...
      user_info_endpoint     = "https://auth.pingone.eu/85a52cf7-357f-40c1-b909-de24d976031d/whatever"
      login_type             = "CODE"
      enable_pkce            = true
      jwks_url               = "https://auth.pingone.eu/85a52cf7-357f-40c1-b909-de24d976031d/as/jwks"
      scopes                 = "openid profile email address phone"
