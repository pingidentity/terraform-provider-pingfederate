...
func certificatesGroup_CheckComputedValuesUpdated() resource.TestCheckFunc {
	return resource.ComposeTestCheckFunc(
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "expires", "2043-12-27T00:00:00Z"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "issuer_dn", "CN=Example Authority, O=Example Corporation, C=US"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "key_algorithm", "RSA"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "key_size", "2048"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "serial_number", "80133226587660155953237711066254559718"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "sha1_fingerprint", "D2B4B2033511D50BABE289E0AF2C17B8DA15FCC3"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "sha256_fingerprint", "6E61905D5223D6667B68D8E600E779B1F13DA404041A8BA7CDF07DB01179A897"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "signature_algorithm", "SHA256withRSA"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "status", "VALID"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "subject_alternative_names.#", "0"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "subject_dn", "CN=Example Authority, O=Example Corporation, C=US"),
		resource.TestCheckResourceAttr("pingfederate_certificates_group.example", "valid_from", "2024-01-01T00:00:00Z"),
