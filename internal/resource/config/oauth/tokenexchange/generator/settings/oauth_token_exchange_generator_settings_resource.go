...
func (r *oauthTokenExchangeGeneratorSettingsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	apiCreateOauthTokenExchangeGeneratorSettings := r.apiClient.OauthTokenExchangeGeneratorAPI.UpdateOauthTokenExchangeSettings(config.ProviderBasicAuthContext(ctx, r.providerConfig))
...
func (r *oauthTokenExchangeGeneratorSettingsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	apiReadOauthTokenExchangeGeneratorSettings, httpResp, err := r.apiClient.OauthTokenExchangeGeneratorAPI.GetOauthTokenExchangeSettings(config.ProviderBasicAuthContext(ctx, r.providerConfig)).Execute()
...
func (r *oauthTokenExchangeGeneratorSettingsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	updateOauthTokenExchangeGeneratorSettings := r.apiClient.OauthTokenExchangeGeneratorAPI.UpdateOauthTokenExchangeSettings(config.ProviderBasicAuthContext(ctx, r.providerConfig))
