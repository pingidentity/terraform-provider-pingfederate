...
func (r *oauthTokenExchangeProcessorPolicyMappingResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	var model *oauthTokenExchangeProcessorPolicyMappingResourceModel
