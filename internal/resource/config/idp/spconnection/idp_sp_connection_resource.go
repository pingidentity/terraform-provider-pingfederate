	...
	schema := schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"additional_allowed_entities_configuration": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"allow_all_entities": schema.BoolAttribute{
						...
						MarkdownDescription: "Set to true to accept any entity or issuer during entity or issuer validation. (Not Recommended)",
					},
				},
				Optional:            true,
				Computed:            true,
				Description:         "Additional allowed entities or issuers configuration. Currently only used in OIDC IdP (RP) connection.",
				MarkdownDescription: "Additional allowed entities or issuers configuration. Currently only used in OIDC IdP (RP) connection.",
			},
			...
			"attribute_query": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"attributes": schema.ListAttribute{
						...
						MarkdownDescription: "The list of attributes that may be returned to the SP in the response to an attribute request.",
				...
				MarkdownDescription: "The attribute query profile supports SPs in requesting user attributes.",
			},
			...
			"connection_target_type": schema.StringAttribute{
				...
				MarkdownDescription: "The connection target type. This field is intended for bulk import/export usage. Changing its value may result in unexpected behavior.",
				Validators: []validator.String{
					stringvalidator.OneOf(
						"STANDARD",
						"SALESFORCE",
			...
			"creation_date": schema.StringAttribute{
				...
				MarkdownDescription: "The time at which the connection was created. This property is read only and is ignored on PUT and POST requests.",
			},
			"credentials": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"certs": schema.ListNestedAttribute{
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"active_verification_cert": schema.BoolAttribute{
									...
									MarkdownDescription: "Indicates whether this is an active signature verification certificate.",
								},
								"cert_view": schema.SingleNestedAttribute{
									Attributes: map[string]schema.Attribute{
										"crypto_provider": schema.StringAttribute{
											...
											MarkdownDescription: "Cryptographic Provider. This is only applicable if Hybrid HSM mode is true.",
											Validators: []validator.String{
												stringvalidator.OneOf(
													"LOCAL",
													"HSM",
										...
										"expires": schema.StringAttribute{
											...
											MarkdownDescription: "The end date up until which the item is valid, in ISO 8601 format (UTC).",
										},
										"id": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The persistent, unique ID for the certificate.",
											MarkdownDescription: "The persistent, unique ID for the certificate.",
										},
										"issuer_dn": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The issuer's distinguished name.",
											MarkdownDescription: "The issuer's distinguished name.",
										},
										"key_algorithm": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The public key algorithm.",
											MarkdownDescription: "The public key algorithm.",
										},
										"key_size": schema.Int64Attribute{
											Optional:            true,
											Computed:            true,
											Description:         "The public key size.",
											MarkdownDescription: "The public key size.",
										},
										"serial_number": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The serial number assigned by the CA.",
											MarkdownDescription: "The serial number assigned by the CA.",
										},
										"sha1fingerprint": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "SHA-1 fingerprint in Hex encoding.",
											MarkdownDescription: "SHA-1 fingerprint in Hex encoding.",
										},
										"sha256fingerprint": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "SHA-256 fingerprint in Hex encoding.",
											MarkdownDescription: "SHA-256 fingerprint in Hex encoding.",
										},
										"signature_algorithm": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The signature algorithm.",
											MarkdownDescription: "The signature algorithm.",
										},
										"status": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "Status of the item.",
											MarkdownDescription: "Status of the item.",
											Validators: []validator.String{
												stringvalidator.OneOf(
													"VALID",
													"EXPIRED",
										...
										"subject_alternative_names": schema.ListAttribute{
											...
											MarkdownDescription: "The subject alternative names (SAN).",
										},
										"subject_dn": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The subject's distinguished name.",
											MarkdownDescription: "The subject's distinguished name.",
										},
										"valid_from": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The start date from which the item is valid, in ISO 8601 format (UTC).",
											MarkdownDescription: "The start date from which the item is valid, in ISO 8601 format (UTC).",
										},
										"version": schema.Int64Attribute{
											Optional:            true,
											Computed:            true,
											Description:         "The X.509 version to which the item conforms.",
											MarkdownDescription: "The X.509 version to which the item conforms.",
										},
									},
									Optional:            true,
									Computed:            true,
								...
								"encryption_cert": schema.BoolAttribute{
									...
									MarkdownDescription: "Indicates whether to use this cert to encrypt outgoing assertions. Only one certificate in the collection can have this flag set.",
								},
								"primary_verification_cert": schema.BoolAttribute{
									...
									MarkdownDescription: "Indicates whether this is the primary signature verification certificate. Only one certificate in the collection can have this flag set.",
								},
								"secondary_verification_cert": schema.BoolAttribute{
									...
									MarkdownDescription: "Indicates whether this is the secondary signature verification certificate. Only one certificate in the collection can have this flag set.",
								},
								"x509file": schema.SingleNestedAttribute{
									Attributes: map[string]schema.Attribute{
										...
										"file_data": schema.StringAttribute{
											...
											MarkdownDescription: "The certificate data in PEM format. New line characters should be omitted or encoded in this value.",
										},
										"id": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											...
											MarkdownDescription: "The persistent, unique ID for the certificate. It can be any combination of [a-z0-9._-]. This property is system-assigned if not specified.",
										},
									},
									Required:            true,
									Description:         "Encoded certificate data.",
									MarkdownDescription: "Encoded certificate data.",
								},
							},
						},
						Optional:            true,
						...
						MarkdownDescription: "The certificates used for signature verification and XML encryption.",
					},
					...
					"inbound_back_channel_auth": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							"certs": schema.ListNestedAttribute{
								...
								MarkdownDescription: "The certificate used for signature verification and XML encryption.",
							},
							...
							"http_basic_credentials": schema.SingleNestedAttribute{
								Attributes: map[string]schema.Attribute{
									"encrypted_password": schema.StringAttribute{
										...
										MarkdownDescription: "For GET requests, this field contains the encrypted password, if one exists.  For POST and PUT requests, if you wish to reuse the existing password, this field should be passed back unchanged.",
									},
									"password": schema.StringAttribute{
										...
										MarkdownDescription: "User password.  To update the password, specify the plaintext value in this field.  This field will not be populated for GET requests.",
									},
					...
					"signing_settings": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							...
							"include_cert_in_signature": schema.BoolAttribute{
								...
								MarkdownDescription: "Determines whether the signing certificate is included in the signature <KeyInfo> element.",
							},
			...
			"extended_properties": schema.MapNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"values": schema.ListAttribute{
							...
							MarkdownDescription: "A List of values",
						},
					},
				},
				Optional:            true,
				...
				MarkdownDescription: "Extended Properties allows to store additional information for IdP/SP Connections. The names of these extended properties should be defined in /extendedProperties.",
			},
			"id": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				...
				MarkdownDescription: "The persistent, unique ID for the connection. It can be any combination of [a-zA-Z0-9._-]. This property is system-assigned if not specified.",
			},
			...
			"modification_date": schema.StringAttribute{
				...
				MarkdownDescription: "The time at which the connection was last changed. This property is read only and is ignored on PUT and POST requests.",
			},
			...
			"outbound_provision": schema.SingleNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"active": schema.BoolAttribute{
									...
									MarkdownDescription: "Indicates whether the channel is the active channel for this connection.",
								},
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"field_name": schema.StringAttribute{
												...
												MarkdownDescription: "The name of target field.",
											},
											"saas_field_info": schema.SingleNestedAttribute{
												Attributes: map[string]schema.Attribute{
													"attribute_names": schema.ListAttribute{
														...
														MarkdownDescription: "The list of source attribute names used to generate or map to a target field",
														Validators: []validator.List{
															listvalidator.UniqueValues(),
														},
													},
													"character_case": schema.StringAttribute{
														...
														MarkdownDescription: "The character case of the field value.",
														Validators: []validator.String{
															stringvalidator.OneOf(
																"LOWER",
																"UPPER",
													...
													"create_only": schema.BoolAttribute{
														...
														MarkdownDescription: "Indicates whether this field is a create only field and cannot be updated.",
													},
													"default_value": schema.StringAttribute{
														Optional:            true,
														Computed:            true,
														Description:         "The default value for the target field",
														MarkdownDescription: "The default value for the target field",
													},
													"expression": schema.StringAttribute{
														Optional:            true,
														Computed:            true,
														Description:         "An OGNL expression to obtain a value.",
														MarkdownDescription: "An OGNL expression to obtain a value.",
													},
													"masked": schema.BoolAttribute{
														Optional:            true,
														Computed:            true,
														Description:         "Indicates whether the attribute should be masked in server logs.",
														MarkdownDescription: "Indicates whether the attribute should be masked in server logs.",
													},
													"parser": schema.StringAttribute{
														Optional:            true,
														Computed:            true,
														Description:         "Indicates how the field shall be parsed.",
														MarkdownDescription: "Indicates how the field shall be parsed.",
														Validators: []validator.String{
															stringvalidator.OneOf(
																"EXTRACT_CN_FROM_DN",
													...
													"trim": schema.BoolAttribute{
														...
														MarkdownDescription: "Indicates whether field should be trimmed before provisioning.",
													},
												},
												Required:            true,
												...
												MarkdownDescription: "The settings that represent how attribute values from source data store will be mapped into Fields specified by the service provider.",
											},
										},
									},
									Required:            true,
									Description:         "The mapping of attributes from the local data store into Fields specified by the service provider.",
									MarkdownDescription: "The mapping of attributes from the local data store into Fields specified by the service provider.",
								},
								"channel_source": schema.SingleNestedAttribute{
										...
										"account_management_settings": schema.SingleNestedAttribute{
											Attributes: map[string]schema.Attribute{
												"account_status_algorithm": schema.StringAttribute{
													...
													MarkdownDescription: "The account status algorithm name. \nACCOUNT_STATUS_ALGORITHM_AD -  Algorithm name for Active Directory, which uses a bitmap for each user entry. \nACCOUNT_STATUS_ALGORITHM_FLAG - Algorithm name for Oracle Directory Server and other LDAP directories that use a separate attribute to store the user's status. When this option is selected, the Flag Comparison Value and Flag Comparison Status fields should be used.",
													Validators: []validator.String{
														stringvalidator.OneOf(
										...
										"change_detection_settings": schema.SingleNestedAttribute{
											Attributes: map[string]schema.Attribute{
												"changed_users_algorithm": schema.StringAttribute{
													...
													MarkdownDescription: "The changed user algorithm. \nACTIVE_DIRECTORY_USN - For Active Directory only, this algorithm queries for update sequence numbers on user records that are larger than the last time records were checked. \nTIMESTAMP - Queries for timestamps on user records that are not older than the last time records were checked. This check is more efficient from the point of view of the PingFederate provisioner but can be more time consuming on the LDAP side, particularly with the Oracle Directory Server. \nTIMESTAMP_NO_NEGATION - Queries for timestamps on user records that are newer than the last time records were checked. This algorithm is recommended for the Oracle Directory Server.",
													Validators: []validator.String{
														stringvalidator.OneOf(
										...
										"group_membership_detection": schema.SingleNestedAttribute{
											Attributes: map[string]schema.Attribute{
												"group_member_attribute_name": schema.StringAttribute{
													...
													MarkdownDescription: "The name of the attribute that represents group members in a group, also known as group member attribute.",
												},
												"member_of_group_attribute_name": schema.StringAttribute{
													...
													MarkdownDescription: "The name of the attribute that indicates the entity is a member of a group, also known as member of attribute.",
												},
											},
											Required:            true,
											Description:         "Settings to detect group memberships.",
											MarkdownDescription: "Settings to detect group memberships.",
										},
									...
									MarkdownDescription: "The source data source and LDAP settings.",
								},
								"max_threads": schema.Int64Attribute{
									Required:            true,
									Description:         "The number of processing threads. The default value is 1.",
									MarkdownDescription: "The number of processing threads. The default value is 1.",
								},
								"name": schema.StringAttribute{
									Required:            true,
								...
								"timeout": schema.Int64Attribute{
									...
									MarkdownDescription: "Timeout, in seconds, for individual user and group provisioning operations on the target service provider. The default value is 60.",
								},
							},
						},
						Required:            true,
						Description:         "Includes settings of a source data store, managing provisioning threads and mapping of attributes.",
						MarkdownDescription: "Includes settings of a source data store, managing provisioning threads and mapping of attributes.",
					},
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"encrypted_value": schema.StringAttribute{
									...
									MarkdownDescription: "For encrypted or hashed fields, this attribute contains the encrypted representation of the field's value, if a value is defined. If you do not want to update the stored value, this attribute should be passed back unchanged.",
								},
								"inherited": schema.BoolAttribute{
									...
									MarkdownDescription: "Whether this field is inherited from its parent instance. If true, the value/encrypted value properties become read-only. The default value is false.",
								},
								"name": schema.StringAttribute{
									Required:            true,
									Description:         "The name of the configuration field.",
									MarkdownDescription: "The name of the configuration field.",
								},
								"value": schema.StringAttribute{
									Optional:            true,
									Computed:            true,
									...
									MarkdownDescription: "The value for the configuration field. For encrypted or hashed fields, GETs will not return this attribute. To update an encrypted or hashed field, specify the new value in this attribute.",
								},
							},
						},
						Required:            true,
						Description:         "Configuration fields that includes credentials to target SaaS application.",
						MarkdownDescription: "Configuration fields that includes credentials to target SaaS application.",
					},
					"type": schema.StringAttribute{
						Required:            true,
						Description:         "The SaaS plugin type.",
						MarkdownDescription: "The SaaS plugin type.",
					},
				},
				Optional:            true,
				Computed:            true,
				...
				MarkdownDescription: "Outbound Provisioning allows an IdP to create and maintain user accounts at standards-based partner sites using SCIM as well as select-proprietary provisioning partner sites that are protocol-enabled.",
			},
			"sp_browser_sso": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"adapter_mappings": schema.ListNestedAttribute{
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"abort_sso_transaction_as_fail_safe": schema.BoolAttribute{
									...
									MarkdownDescription: "If set to true, SSO transaction will be aborted as a fail-safe when the data-store's attribute mappings fail to complete the attribute contract. Otherwise, the attribute contract with default values is used. By default, this value is false.",
								},
										...
										"attribute_contract": schema.SingleNestedAttribute{
											Attributes: map[string]schema.Attribute{
													...
													NestedObject: schema.NestedAttributeObject{
														Attributes: map[string]schema.Attribute{
															...
															"pseudonym": schema.BoolAttribute{
																...
																MarkdownDescription: "Specifies whether this attribute is used to construct a pseudonym for the SP. Defaults to false.",
															},
														},
													},
													Required:            true,
													Description:         "A list of IdP adapter attributes that correspond to the attributes exposed by the IdP adapter type.",
													MarkdownDescription: "A list of IdP adapter attributes that correspond to the attributes exposed by the IdP adapter type.",
												},
												"extended_attributes": schema.ListNestedAttribute{
													...
													MarkdownDescription: "A list of additional attributes that can be returned by the IdP adapter. The extended attributes are only used if the adapter supports them.",
												},
												"inherited": schema.BoolAttribute{
													Optional:            true,
													Computed:            true,
													...
													MarkdownDescription: "Whether this attribute contract is inherited from its parent instance. If true, the rest of the properties in this model become read-only. The default value is false.",
												},
												"mask_ognl_values": schema.BoolAttribute{
													...
													MarkdownDescription: "Whether or not all OGNL expressions used to fulfill an outgoing assertion contract should be masked in the logs. Defaults to false.",
												},
												"unique_user_key_attribute": schema.StringAttribute{
													...
													MarkdownDescription: "The attribute to use for uniquely identify a user's authentication sessions.",
												},
											},
											Optional:            true,
											Computed:            true,
											Description:         "A set of attributes exposed by an IdP adapter.",
											MarkdownDescription: "A set of attributes exposed by an IdP adapter.",
										},
										"attribute_mapping": schema.SingleNestedAttribute{
											Attributes: map[string]schema.Attribute{
												...
												"inherited": schema.BoolAttribute{
													...
													MarkdownDescription: "Whether this attribute mapping is inherited from its parent instance. If true, the rest of the properties in this model become read-only. The default value is false.",
												},
												"issuance_criteria": schema.SingleNestedAttribute{
													Attributes: map[string]schema.Attribute{
														"conditional_criteria": schema.ListNestedAttribute{
											...
											MarkdownDescription: "An IdP Adapter Contract Mapping.",
										},
										"authn_ctx_class_ref": schema.StringAttribute{
											Optional:            true,
											Computed:            true,
											Description:         "The fixed value that indicates how the user was authenticated.",
											MarkdownDescription: "The fixed value that indicates how the user was authenticated.",
										},
										"configuration": schema.SingleNestedAttribute{
											Attributes: map[string]schema.Attribute{
												"fields": schema.ListNestedAttribute{
													...
													MarkdownDescription: "List of configuration fields.",
												},
												"tables": schema.ListNestedAttribute{
													NestedObject: schema.NestedAttributeObject{
														Attributes: map[string]schema.Attribute{
															"inherited": schema.BoolAttribute{
																...
																MarkdownDescription: "Whether this table is inherited from its parent instance. If true, the rows become read-only. The default value is false.",
															},
															"name": schema.StringAttribute{
																Required:            true,
															...
															"rows": schema.ListNestedAttribute{
																NestedObject: schema.NestedAttributeObject{
																	Attributes: map[string]schema.Attribute{
																		"default_row": schema.BoolAttribute{
																			...
																			MarkdownDescription: "Whether this row is the default.",
																		},
																		"fields": schema.ListNestedAttribute{
																			NestedObject: schema.NestedAttributeObject{
																				Attributes: map[string]schema.Attribute{
																			...
																			MarkdownDescription: "The configuration fields in the row.",
																		},
																	},
																},
																Optional:            true,
																...
																MarkdownDescription: "List of table rows.",
															},
														},
													},
													Optional:            true,
													...
													MarkdownDescription: "List of configuration tables.",
												},
											},
											Required:            true,
											Description:         "Configuration settings for a plugin instance.",
											MarkdownDescription: "Configuration settings for a plugin instance.",
										},
										"id": schema.StringAttribute{
											Required:            true,
											...
											MarkdownDescription: "The ID of the plugin instance. The ID cannot be modified once the instance is created.<br>Note: Ignored when specifying a connection's adapter override.",
										},
										"name": schema.StringAttribute{
											Required:            true,
											...
											MarkdownDescription: "The plugin instance name. The name can be modified once the instance is created.<br>Note: Ignored when specifying a connection's adapter override.",
										},
						...
						MarkdownDescription: "A list of adapters that map to outgoing assertions.",
					},
					...
					"assertion_lifetime": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							"minutes_after": schema.Int64Attribute{
								...
								MarkdownDescription: "Assertion validity in minutes after the assertion issuance.",
							},
							"minutes_before": schema.Int64Attribute{
								Required:            true,
								Description:         "Assertion validity in minutes before the assertion issuance.",
								MarkdownDescription: "Assertion validity in minutes before the assertion issuance.",
							},
						},
						Required:            true,
						Description:         "The timeframe of validity before and after the issuance of the assertion.",
						MarkdownDescription: "The timeframe of validity before and after the issuance of the assertion.",
					},
					"attribute_contract": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							"core_attributes": schema.ListNestedAttribute{
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"name_format": schema.StringAttribute{
											...
											MarkdownDescription: "The SAML Name Format for the attribute.",
										},
									},
								},
								Optional:            true,
								...
								MarkdownDescription: "A list of read-only assertion attributes (for example, SAML_SUBJECT) that are automatically populated by PingFederate.",
							},
							"extended_attributes": schema.ListNestedAttribute{
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
								...
								MarkdownDescription: "A list of additional attributes that are added to the outgoing assertion.",
							},
						},
						Required:            true,
					...
					"authentication_policy_contract_assertion_mappings": schema.ListNestedAttribute{
						...
						MarkdownDescription: "A list of authentication policy contracts that map to outgoing assertions.",
					},
					"default_target_url": schema.StringAttribute{
						...
						MarkdownDescription: "Default Target URL for SAML1.x connections. For SP connections, this default URL represents the destination on the SP where the user will be directed. For IdP connections, entering a URL in the Default Target URL field overrides the SP Default URL SSO setting.",
					},
					...
					"encryption_policy": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							"encrypt_assertion": schema.BoolAttribute{
								...
								MarkdownDescription: "Whether the outgoing SAML assertion will be encrypted.",
							},
							"encrypt_slo_subject_name_id": schema.BoolAttribute{
								...
								MarkdownDescription: "Encrypt the name-identifier attribute in outbound SLO messages.  This can be set if the name id is encrypted.",
							},
							"encrypted_attributes": schema.ListAttribute{
								...
								MarkdownDescription: "The list of outgoing SAML assertion attributes that will be encrypted. The 'encryptAssertion' property takes precedence over this.",
							},
							"slo_subject_name_idencrypted": schema.BoolAttribute{
								...
								MarkdownDescription: "Allow the encryption of the name-identifier attribute for inbound SLO messages. This can be set if SP initiated SLO is enabled.",
							},
						},
						Required:            true,
						Description:         "Defines what to encrypt in the browser-based SSO profile.",
						MarkdownDescription: "Defines what to encrypt in the browser-based SSO profile.",
					},
					...
					"require_signed_authn_requests": schema.BoolAttribute{
						...
						MarkdownDescription: "Require AuthN requests to be signed when received via the POST or Redirect bindings.",
					},
					"sign_assertions": schema.BoolAttribute{
						Optional:            true,
						Computed:            true,
						Description:         "Always sign the SAML Assertion.",
						MarkdownDescription: "Always sign the SAML Assertion.",
					},
					"sign_response_as_required": schema.BoolAttribute{
						...
						MarkdownDescription: "Sign SAML Response as required by the associated binding and encryption policy. Applicable to SAML2.0 only and is defaulted to true. It can be set to false only on SAML2.0 connections when signAssertions is set to true.",
					},
					...
					"sp_saml_identity_mapping": schema.StringAttribute{
						...
						MarkdownDescription: "Process in which users authenticated by the IdP are associated with user accounts local to the SP.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"PSEUDONYM",
								"STANDARD",
					...
					"sp_ws_fed_identity_mapping": schema.StringAttribute{
						...
						MarkdownDescription: "Process in which users authenticated by the IdP are associated with user accounts local to the SP for WS-Federation connection types.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"EMAIL_ADDRESS",
								"USER_PRINCIPLE_NAME",
					...
					"sso_service_endpoints": schema.ListNestedAttribute{
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"binding": schema.StringAttribute{
									...
									MarkdownDescription: "The binding of this endpoint, if applicable - usually only required for SAML 2.0 endpoints.  Supported bindings are Artifact and POST.",
									Validators: []validator.String{
										stringvalidator.OneOf(
											"ARTIFACT",
											"POST",
								...
								"is_default": schema.BoolAttribute{
									...
									MarkdownDescription: "Whether or not this endpoint is the default endpoint. Defaults to false.",
								},
								"url": schema.StringAttribute{
									Required:            true,
									Description:         "The absolute or relative URL of the endpoint. A relative URL can be specified if a base URL for the connection has been defined.",
						...
						MarkdownDescription: "A list of possible endpoints to send assertions to.",
					},
					...
					"ws_fed_token_type": schema.StringAttribute{
						...
						MarkdownDescription: "The WS-Federation Token Type to use.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"SAML11",
								"SAML20",
					...
					"ws_trust_version": schema.StringAttribute{
						...
						MarkdownDescription: "The WS-Trust version for a WS-Federation connection. The default version is WSTRUST12.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"WSTRUST12",
								"WSTRUST13",
				...
				MarkdownDescription: "The SAML settings used to enable secure browser-based SSO to resources at your partner's site.",
			},
			"type": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"ws_trust": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"abort_if_not_fulfilled_from_request": schema.BoolAttribute{
						...
						MarkdownDescription: "If the attribute contract cannot be fulfilled using data from the Request, abort the transaction.",
					},
					"attribute_contract": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							"core_attributes": schema.ListNestedAttribute{
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"namespace": schema.StringAttribute{
											...
											MarkdownDescription: "The attribute namespace.  This is required when the Default Token Type is SAML2.0 or SAML1.1 or SAML1.1 for Office 365.",
										},
									},
								},
								Optional:            true,
						...
						MarkdownDescription: "A set of user attributes that this server will send in the token.",
					},
					"default_token_type": schema.StringAttribute{
						...
						MarkdownDescription: "The default token type when a web service client (WSC) does not specify in the token request which token type the STS should issue. Defaults to SAML 2.0.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"SAML20",
								"SAML11",
					...
					"encrypt_saml2assertion": schema.BoolAttribute{
						...
						MarkdownDescription: "When selected, the STS encrypts the SAML 2.0 assertion. Applicable only to SAML 2.0 security token.  This option does not apply to OAuth assertion profiles.",
					},
					"generate_key": schema.BoolAttribute{
						...
						MarkdownDescription: "When selected, the STS generates a symmetric key to be used in conjunction with the \"Holder of Key\" (HoK) designation for the assertion's Subject Confirmation Method.  This option does not apply to OAuth assertion profiles.",
					},
					"message_customizations": schema.ListNestedAttribute{
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
						...
						MarkdownDescription: "The message customizations for WS-Trust. Depending on server settings, connection type, and protocol this may or may not be supported.",
					},
					"minutes_after": schema.Int64Attribute{
						Optional:            true,
						Computed:            true,
						...
						MarkdownDescription: "The amount of time after the SAML token was issued during which it is to be considered valid. The default value is 30.",
					},
					"minutes_before": schema.Int64Attribute{
						Optional:            true,
						Computed:            true,
						...
						MarkdownDescription: "The amount of time before the SAML token was issued during which it is to be considered valid. The default value is 5.",
					},
					"o_auth_assertion_profiles": schema.BoolAttribute{
						...
						MarkdownDescription: "When selected, four additional token-type requests become available.",
					},
					"partner_service_ids": schema.ListAttribute{
						ElementType:         types.StringType,
						Required:            true,
						Description:         "The partner service identifiers.",
						MarkdownDescription: "The partner service identifiers.",
					},
					...
					"token_processor_mappings": schema.ListNestedAttribute{
						...
						MarkdownDescription: "A list of token processors to validate incoming tokens.",
					},
				},
				Optional:            true,
				Computed:            true,
				...
				MarkdownDescription: "Ws-Trust STS provides security-token validation and creation to extend SSO access to identity-enabled Web Services",
			},
		},
	}
...
func readIdpSpconnectionResponse(ctx context.Context, r *client.SpConnection, state *idpSpConnectionResourceModel) diag.Diagnostics {
	...
	/*state.SpBrowserSso = (r.SpBrowserSso)
	state.Type = internaltypes.StringTypeOrNil(r.Type)
	state.Id = internaltypes.StringTypeOrNil(r.Id)
	state.EntityId = internaltypes.StringTypeOrNil(r.EntityId)
	state.Name = internaltypes.StringTypeOrNil(r.Name)
	state.ModificationDate = internaltypes.StringTypeOrNil(r.ModificationDate)
	state.CreationDate = internaltypes.StringTypeOrNil(r.CreationDate)
	state.Active = types.BoolValue(r.Active)
	state.BaseUrl = internaltypes.StringTypeOrNil(r.BaseUrl)
	state.DefaultVirtualEntityId = internaltypes.StringTypeOrNil(r.DefaultVirtualEntityId)
	state.VirtualEntityIds = internaltypes.GetCorrectMethodFromInternalTypesForThis(r.VirtualEntityIds)
	state.MetadataReloadSettings = (r.MetadataReloadSettings)
	state.Credentials = (r.Credentials)
	state.ContactInfo = (r.ContactInfo)
	state.LicenseConnectionGroup = internaltypes.StringTypeOrNil(r.LicenseConnectionGroup)
	state.LoggingMode = internaltypes.StringTypeOrNil(r.LoggingMode)
	state.AdditionalAllowedEntitiesConfiguration = (r.AdditionalAllowedEntitiesConfiguration)
	state.ExtendedProperties = (r.ExtendedProperties)
	state.AttributeQuery = (r.AttributeQuery)
	state.WsTrust = (r.WsTrust)
	state.ApplicationName = internaltypes.StringTypeOrNil(r.ApplicationName)
	state.ApplicationIconUrl = internaltypes.StringTypeOrNil(r.ApplicationIconUrl)
	state.OutboundProvision = (r.OutboundProvision)
	state.ConnectionTargetType = internaltypes.StringTypeOrNil(r.ConnectionTargetType)*/
