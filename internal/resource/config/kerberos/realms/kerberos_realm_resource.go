	...
	schema := schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"kerberos_encrypted_password": schema.StringAttribute{
				Description: "This field contains the encrypted Domain/Realm password, if one exists. Only applicable when 'connectionType' is DIRECT.",
				Computed:    true,
				Optional:    false,
				Sensitive:   true,
			},
			// Computed due to dependency on connection_type, this value is not present when connection_type is LDAP_GATEWAY
...
func (r *kerberosRealmsResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	if model.ConnectionType.IsNull() {
		if !internaltypes.IsDefined(model.KerberosUsername) {
...
func (r *kerberosRealmsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	apiCreateKerberosRealms := r.apiClient.KerberosRealmsAPI.CreateKerberosRealm(config.ProviderBasicAuthContext(ctx, r.providerConfig))
...
func (r *kerberosRealmsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	apiReadKerberosRealms, httpResp, err := r.apiClient.KerberosRealmsAPI.GetKerberosRealm(config.ProviderBasicAuthContext(ctx, r.providerConfig), state.RealmId.ValueString()).Execute()
...
func (r *kerberosRealmsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	updateKerberosRealms := r.apiClient.KerberosRealmsAPI.UpdateKerberosRealm(config.ProviderBasicAuthContext(ctx, r.providerConfig), plan.RealmId.ValueString())
...
func (r *kerberosRealmsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	httpResp, err := r.apiClient.KerberosRealmsAPI.DeleteKerberosRealm(config.ProviderBasicAuthContext(ctx, r.providerConfig), state.RealmId.ValueString()).Execute()
