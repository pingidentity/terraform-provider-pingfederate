...
var (
	_ datasource.DataSource              = &localIdentityProfileDataSource{}
	_ datasource.DataSourceWithConfigure = &localIdentityProfileDataSource{}
)

// Create a Administrative Account data source
func LocalIdentityProfileDataSource() datasource.DataSource {
	return &localIdentityProfileDataSource{}
}

// localIdentityProfileDataSource is the datasource implementation.
type localIdentityProfileDataSource struct {
	providerConfig internaltypes.ProviderConfiguration
	apiClient      *client.APIClient
}

// GetSchema defines the schema for the datasource.
func (r *localIdentityProfileDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *localIdentityProfileDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_local_identity_profile"
}

// Configure adds the provider configured client to the data source.
func (r *localIdentityProfileDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func readLocalIdentityProfileResponseDataSource(ctx context.Context, r *client.LocalIdentityProfile, state *localIdentityProfileModel) diag.Diagnostics {
...
func (r *localIdentityProfileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	apiReadLocalIdentityProfile, httpResp, err := r.apiClient.LocalIdentityIdentityProfilesAPI.GetIdentityProfile(config.AuthContext(ctx, r.providerConfig), state.ProfileId.ValueString()).Execute()
	if err != nil {
	...
	diags = readLocalIdentityProfileResponseDataSource(ctx, apiReadLocalIdentityProfile, &state)
	resp.Diagnostics.Append(diags...)
