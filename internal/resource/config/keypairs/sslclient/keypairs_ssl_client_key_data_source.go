...
var (
	_ datasource.DataSource              = &keypairsSslClientKeyDataSource{}
	_ datasource.DataSourceWithConfigure = &keypairsSslClientKeyDataSource{}
)

// KeypairsSslClientKeyDataSource is a helper function to simplify the provider implementation.
func KeypairsSslClientKeyDataSource() datasource.DataSource {
	return &keypairsSslClientKeyDataSource{}
}

// keypairsSslClientKeyDataSource is the data source implementation.
type keypairsSslClientKeyDataSource struct {
	providerConfig internaltypes.ProviderConfiguration
	apiClient      *client.APIClient
}

type keypairsSslClientKeyDataSourceModel struct {
...
func (r *keypairsSslClientKeyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Data source to retrieve a ssl client key pair.",
...
func (state *keypairsSslClientKeyDataSourceModel) readClientResponse(response *client.KeyPairView) diag.Diagnostics {
...
func (r *keypairsSslClientKeyDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_keypairs_ssl_client_key"
}

func (r *keypairsSslClientKeyDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (r *keypairsSslClientKeyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data keypairsSslClientKeyDataSourceModel
