...
func (r *keypairsOauthOpenidConnectResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	if config.StaticJwksEnabled.ValueBool() {
		...
		validateActiveAndPreviousCertRef("p256decryption_", config.P256decryptionActiveCertRef, config.P256decryptionPreviousCertRef, resp)
		validateActiveAndPreviousCertRef("p384", config.P384activeCertRef, config.P384previousCertRef, resp)
		validateActiveAndPreviousCertRef("p384decryption_", config.P384decryptionActiveCertRef, config.P384decryptionPreviousCertRef, resp)
		validateActiveAndPreviousCertRef("p521", config.P521activeCertRef, config.P521previousCertRef, resp)
		validateActiveAndPreviousCertRef("p521decryption_", config.P521decryptionActiveCertRef, config.P521decryptionPreviousCertRef, resp)
		...
		addValidateConfigErrorIfDefined("p256active_cert_ref", internaltypes.IsDefined(config.P256activeCertRef), resp)
		addValidateConfigErrorIfDefined("p256active_key_id", internaltypes.IsDefined(config.P256activeKeyId), resp)
		addValidateConfigErrorIfDefined("p256decryption_active_cert_ref", internaltypes.IsDefined(config.P256decryptionActiveCertRef), resp)
		addValidateConfigErrorIfDefined("p256decryption_active_key_id", internaltypes.IsDefined(config.P256decryptionActiveKeyId), resp)
		addValidateConfigErrorIfDefined("p256decryption_previous_cert_ref", internaltypes.IsDefined(config.P256decryptionPreviousCertRef), resp)
		addValidateConfigErrorIfDefined("p256decryption_previous_key_id", internaltypes.IsDefined(config.P256decryptionPreviousKeyId), resp)
		addValidateConfigErrorIfDefined("p256decryption_publish_x5c_parameter", internaltypes.IsDefined(config.P256decryptionPublishX5cParameter), resp)
		addValidateConfigErrorIfDefined("p256previous_cert_ref", internaltypes.IsDefined(config.P256previousCertRef), resp)
		addValidateConfigErrorIfDefined("p256previous_key_id", internaltypes.IsDefined(config.P256previousKeyId), resp)
		addValidateConfigErrorIfDefined("p256publish_x5c_parameter", internaltypes.IsDefined(config.P256publishX5cParameter), resp)
		addValidateConfigErrorIfDefined("p384active_cert_ref", internaltypes.IsDefined(config.P384activeCertRef), resp)
		addValidateConfigErrorIfDefined("p384active_key_id", internaltypes.IsDefined(config.P384activeKeyId), resp)
		addValidateConfigErrorIfDefined("p384decryption_active_cert_ref", internaltypes.IsDefined(config.P384decryptionActiveCertRef), resp)
		addValidateConfigErrorIfDefined("p384decryption_active_key_id", internaltypes.IsDefined(config.P384decryptionActiveKeyId), resp)
		addValidateConfigErrorIfDefined("p384decryption_previous_cert_ref", internaltypes.IsDefined(config.P384decryptionPreviousCertRef), resp)
		addValidateConfigErrorIfDefined("p384decryption_previous_key_id", internaltypes.IsDefined(config.P384decryptionPreviousKeyId), resp)
		addValidateConfigErrorIfDefined("p384decryption_publish_x5c_parameter", internaltypes.IsDefined(config.P384decryptionPublishX5cParameter), resp)
		addValidateConfigErrorIfDefined("p384previous_cert_ref", internaltypes.IsDefined(config.P384previousCertRef), resp)
		addValidateConfigErrorIfDefined("p384previous_key_id", internaltypes.IsDefined(config.P384previousKeyId), resp)
		addValidateConfigErrorIfDefined("p384publish_x5c_parameter", internaltypes.IsDefined(config.P384publishX5cParameter), resp)
		addValidateConfigErrorIfDefined("p521active_cert_ref", internaltypes.IsDefined(config.P521activeCertRef), resp)
		addValidateConfigErrorIfDefined("p521active_key_id", internaltypes.IsDefined(config.P521activeKeyId), resp)
		addValidateConfigErrorIfDefined("p521decryption_active_cert_ref", internaltypes.IsDefined(config.P521decryptionActiveCertRef), resp)
		addValidateConfigErrorIfDefined("p521decryption_active_key_id", internaltypes.IsDefined(config.P521decryptionActiveKeyId), resp)
		addValidateConfigErrorIfDefined("p521decryption_previous_cert_ref", internaltypes.IsDefined(config.P521decryptionPreviousCertRef), resp)
		addValidateConfigErrorIfDefined("p521decryption_previous_key_id", internaltypes.IsDefined(config.P521decryptionPreviousKeyId), resp)
		addValidateConfigErrorIfDefined("p521decryption_publish_x5c_parameter", internaltypes.IsDefined(config.P521decryptionPublishX5cParameter), resp)
		addValidateConfigErrorIfDefined("p521previous_cert_ref", internaltypes.IsDefined(config.P521previousCertRef), resp)
		addValidateConfigErrorIfDefined("p521previous_key_id", internaltypes.IsDefined(config.P521previousKeyId), resp)
		addValidateConfigErrorIfDefined("p521publish_x5c_parameter", internaltypes.IsDefined(config.P521publishX5cParameter), resp)
