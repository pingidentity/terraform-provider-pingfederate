...
func ToState(ctx context.Context, response *client.PolicyActionAggregation) (types.Object, diag.Diagnostics) {
	...
	if response.ApcMappingPolicyAction != nil {
		...
		actionAttrs["attribute_mapping"], respDiags = attributemapping.ToState(ctx, &response.ApcMappingPolicyAction.AttributeMapping, true)
		diags.Append(respDiags...)
		...
		diags.Append(respDiags...)
		actionAttrs["fragment_mapping"], respDiags = attributemapping.ToState(ctx, response.FragmentPolicyAction.FragmentMapping, true)
		diags.Append(respDiags...)
		...
		diags.Append(respDiags...)
		actionAttrs["inbound_mapping"], respDiags = attributemapping.ToState(ctx, response.LocalIdentityMappingPolicyAction.InboundMapping, true)
		diags.Append(respDiags...)
		actionAttrs["outbound_attribute_mapping"], respDiags = attributemapping.ToState(ctx, &response.LocalIdentityMappingPolicyAction.OutboundAttributeMapping, true)
		diags.Append(respDiags...)
