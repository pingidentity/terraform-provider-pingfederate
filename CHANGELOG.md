...
* Fix URL config validator where asterisks in value returned \"Invalid URL Format\" ([#445](https://github.com/pingidentity/terraform-provider-pingfederate/pull/445))
